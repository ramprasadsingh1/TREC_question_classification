...
def trainmodel():
    if cfg['classification'] == 'coarse':
        ...
        # Load Glove
        ## Create a dictionary of glove {word:vector}
        import numpy as np
        glove_file = cfg['path_embedding']
        glove_dict = {}
        ...
        class TrainValTestModel():
            ...
            def train(self, sub_train):
                ...
                train_loss = 0
                train_acc = 0
                data = DataLoader(sub_train, batch_size=self.batch_size, shuffle=True, collate_fn=self.collate_fn)
            ...
            def savelabels(self):
                return np.asarray(self.test_preds).astype(int)
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'random' and cfg['setting'] == 'finetune':
            PATH = "src\models\classcoarse_bow_random_finetune.pt"
            ...
            PATH = "src\models\classcoarse_bow_glove_freeze.pt"
            ...
            PATH = "src\models\classcoarse_bow_glove_finetune.pt"
            ...
            PATH = "src\models\classcoarse_bilstm_random_finetune.pt"
            ...
            PATH = "src\models\classcoarse_bilstm_glove_freeze.pt"
            ...
            PATH = "src\models\classcoarse_bilstm_glove_finetune.pt"
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'random' and cfg['setting'] == 'finetune':
            PATH = "src\models\classfine_bow_random_finetune.pt"
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'glove' and cfg['setting'] == 'freeze':
            PATH = "src\models\classfine_bow_glove_freeze.pt"
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'glove' and cfg['setting'] == 'finetune':
            PATH = "src\models\classfine_bow_glove_finetune.pt"
        ...
        if cfg['model'] == 'bilstm' and cfg['embedding'] == 'random' and cfg['setting'] == 'finetune':
            PATH = "src\models\classfine_bilstm_random_finetune.pt"
        ...
        if cfg['model'] == 'bilstm' and cfg['embedding'] == 'glove' and cfg['setting'] == 'freeze':
            PATH = "src\models\classfine_bilstm_glove_freeze.pt"
            ...
            torch.save(model11.state_dict(), PATH)

        if cfg['model'] == 'bilstm' and cfg['embedding'] == 'glove' and cfg['setting'] == 'finetune':
            PATH = "src\models\classfine_bilstm_glove_finetune.pt"
            ...
            torch.save(model12.state_dict(), PATH)

# DEFINE TESTMODEL FOR ARGPARSE
def testmodel():
    if cfg['classification'] == 'coarse':
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'random' and cfg['setting'] == 'finetune':
            ...
            np.savetxt('src\labels\classcoarse_bow_random_fine_labels.txt', model1_evaluator.savelabels())
            ...
            np.savetxt('src\labels\classcoarse_bow_glove_freeze_labels.txt', model2_evaluator.savelabels())
            ...
            np.savetxt('src\labels\classcoarse_bow_glove_fine_labels.txt', model3_evaluator.savelabels())
            ...
            np.savetxt('src\labels\classcoarse_bilstm_random_fine_labels.txt', model4_evaluator.savelabels())
            ...
            np.savetxt('src\labels\classcoarse_bilstm_glove_freeze_labels.txt', model5_evaluator.savelabels())
            ...
            np.savetxt('src\labels\classcoarse_bilstm_glove_fine_labels.txt', model6_evaluator.savelabels())
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'random' and cfg['setting'] == 'finetune':
            ...
            np.savetxt('src\labels\classfine_bow_random_finetune_labels.txt', model7_evaluator.savelabels())
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'glove' and cfg['setting'] == 'freeze':
            ...
            np.savetxt('src\labels\classfine_bow_glove_freeze_labels.txt', model8_evaluator.savelabels())
        ...
        if cfg['model'] == 'bow' and cfg['embedding'] == 'glove' and cfg['setting'] == 'finetune':
            ...
            np.savetxt('src\labels\classfine_bow_glove_finetune_labels.txt', model9_evaluator.savelabels())
        ...
        if cfg['model'] == 'bilstm' and cfg['embedding'] == 'random' and cfg['setting'] == 'finetune':
            ...
            np.savetxt('src\labels\classfine_bilstm_random_finetune_labels.txt', model10_evaluator.savelabels())
        ...
        if cfg['model'] == 'bilstm' and cfg['embedding'] == 'glove' and cfg['setting'] == 'freeze':
            ...
            np.savetxt('src\labels\classfine_bilstm_glove_free_labels.txt', model11_evaluator.savelabels())
        ...
        if cfg['model'] == 'bilstm' and cfg['embedding'] == 'glove' and cfg['setting'] == 'finetune':
            ...
            np.savetxt('src\labels\classfine_bilstm_glove_finetune_labels.txt', model12_evaluator.savelabels())

# import argparse to interact from command line
import argparse
parser = argparse.ArgumentParser()
parser.add_argument('--config', type=str, required=True, help='Configuration file')
parser.add_argument('--trainmodel', action='store_true', help='Training mode - model is saved')
parser.add_argument('--testmodel', action='store_true', help='Testing mode - needs a model to load')
